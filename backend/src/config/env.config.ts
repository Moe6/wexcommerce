 ...
 * @type {number}
 */
export const BATCH_SIZE = Number.parseInt(__env__('WC_BATCH_SIZE', false, '1000'), 10)
 ...
 * @type {"wc-x-access-token-frontend"}
 */
export const ADMIN_AUTH_COOKIE_NAME = 'wc-x-access-token-admin'
 ...
 * @type {string}
 */
export const ADMIN_HOST = __env__('WC_ADMIN_HOST', true)
 ...
 * @type {boolean}
 */
export const PAYPAL_SANDBOX = helper.StringToBoolean(__env__('WC_PAYPAL_SANDBOX', false, 'true'))
 ...
 * @type {string}
 */
export const IPINFO_API_KEY = __env__('WC_IPINFO_API_KEY', false)
 ...
 * @type {string}
 */
export const IPINFO_DEFAULT_COUNTRY = __env__('WC_IPINFO_DEFAULT_COUNTRY', false, 'US')
 ...
 * @type {boolean}
 */
export const ENABLE_SENTRY = helper.StringToBoolean(__env__('WC_ENABLE_SENTRY', false, 'false'))
 ...
 * @type {string}
 */
export const SENTRY_DSN_BACKEND = __env__('WC_SENTRY_DSN_BACKEND', ENABLE_SENTRY)
 ...
 * @type {number}
 */
export const SENTRY_TRACES_SAMPLE_RATE = Number.parseFloat(__env__('WC_SENTRY_TRACES_SAMPLE_RATE', false, '1.0'))
