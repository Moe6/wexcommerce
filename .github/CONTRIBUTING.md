...
Welcome to the **lebobeautyco** Contribution Guide!  

We appreciate your interest in contributing to lebobeautyco. This guide will help you get started, follow best practices, and make your contributions smooth and effective.
...
- **Clone your fork** locally:
  ```bash
  git clone https://github.com/your-username/lebobeautyco.git
  ```
...
- **Setup environment variables** according to the [Run from Source Guide](https://github.com/Moe6/lebobeautyco/wiki/Run-from-Source) or [Run from Source Docker Guide](https://github.com/Moe6/lebobeautyco/wiki/Run-from-Source-(Docker)).  
...
- lebobeautyco uses **TypeScript** across the stack.  
- Follow **ESLint** rules.  
...
- Open a **Pull Request** (PR) against the lebobeautyco `main` branch.  
...
See the [Testing Wiki](https://github.com/Moe6/lebobeautyco/wiki/Testing) for more details.

## Pre-commit Checks

- lebobeautyco uses **Husky** to run pre-commit hooks: linting, type checking, and file size checks.  
...
- Use the [GitHub Issues](https://github.com/Moe6/lebobeautyco/issues) page to report bugs or request features.  
...
Thank you for helping make lebobeautyco better! Your contributions are valued and make a difference.
