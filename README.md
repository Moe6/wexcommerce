[![build](https://github.com/Moe6/lebobeautyco/actions/workflows/build.yml/badge.svg)](https://github.com/Moe6/lebobeautyco/actions/workflows/build.yml) 
[![test](https://github.com/Moe6/lebobeautyco/actions/workflows/test.yml/badge.svg)](https://github.com/Moe6/lebobeautyco/actions/workflows/test.yml) 
[![coveralls](https://coveralls.io/repos/github/aelassas/lebobeautyco/badge.svg?branch=main)](https://coveralls.io/github/aelassas/lebobeautyco?branch=main)
[![containerize](https://github.com/Moe6/lebobeautyco/actions/workflows/containerize.yml/badge.svg)](https://github.com/Moe6/lebobeautyco/actions/workflows/containerize.yml) 
[![loc](https://raw.githubusercontent.com/aelassas/lebobeautyco/refs/heads/loc/badge.svg)](https://github.com/Moe6/lebobeautyco/actions/workflows/loc.yml) 
[![live demo](https://img.shields.io/badge/live-demo-brightgreen)](https://lebobeautyco.dynv6.net:8002/)

<!--
[![tested with jest](https://img.shields.io/badge/tested_with-jest-brightgreen?logo=jest)](https://github.com/jestjs/jest)
[![docs](https://img.shields.io/badge/docs-wiki-brightgreen)](https://github.com/Moe6/lebobeautyco/wiki)
[![live demo](https://img.shields.io/badge/live-demo-brightgreen)](https://lebobeautyco.dynv6.net:8002/)
[![loc](https://raw.githubusercontent.com/aelassas/lebobeautyco/refs/heads/loc/badge.svg)](https://github.com/Moe6/lebobeautyco/actions/workflows/loc.yml)
[![PRs welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](https://github.com/Moe6/lebobeautyco/pulls)
[![codecov](https://codecov.io/gh/aelassas/lebobeautyco/graph/badge.svg?token=ZNW4QHSFPH)](https://codecov.io/gh/aelassas/lebobeautyco)
[![codecov](https://img.shields.io/codecov/c/github/aelassas/lebobeautyco?label=coverage)](https://codecov.io/gh/aelassas/lebobeautyco)
[![coveralls](https://coveralls.io/repos/github/aelassas/lebobeautyco/badge.svg?branch=main)](https://coveralls.io/github/aelassas/lebobeautyco?branch=main)
[![live demo](https://img.shields.io/badge/live-demo-brightgreen)](https://lebobeautyco.dynv6.net:8002/)
[![open-vscode](https://img.shields.io/badge/open-vscode-1f425f.svg)](https://vscode.dev/github/aelassas/lebobeautyco/)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](https://github.com/Moe6/lebobeautyco/blob/main/.github/CONTRIBUTING.md)
...
[![](https://lebobeautyco.github.io/content/cover.png)](https://lebobeautyco.dynv6.net:8002/home)

## lebobeautyco
 
lebobeautyco is an open-source and cross-platform single-vendor marketplace offering an SEO-optimized web storefront and a powerful admin panel for managing your online store.
...
## Quick Links
* [Overview](https://github.com/Moe6/lebobeautyco/wiki/Overview)
* [Install Guide (Self-hosted)](https://github.com/Moe6/lebobeautyco/wiki/Installing-(Self%E2%80%90hosted))
* [Install Guide (Docker)](https://github.com/Moe6/lebobeautyco/wiki/Installing-(Docker))
* [Payment Gateways](https://github.com/Moe6/lebobeautyco/wiki/Payment-Gateways)
* [Change Language and Currency](https://github.com/Moe6/lebobeautyco/wiki/Change-Language-and-Currency)
* [FAQ](https://github.com/Moe6/lebobeautyco/wiki/FAQ)
* [Full Documentation](https://github.com/Moe6/lebobeautyco/wiki)
...
To contribute code or report issues, please read the [Contribution Guide](https://github.com/Moe6/lebobeautyco/blob/main/.github/CONTRIBUTING.md) to learn about the process, coding standards, and how to submit pull requests.

If you want to customize lebobeautyco while keeping your fork up to date with the latest changes, check out the [Fork, Customize, and Sync](https://github.com/Moe6/lebobeautyco/wiki/Fork,-Customize,-and-Sync) guide in the Wiki.

## Live Demo

* URL: https://lebobeautyco.dynv6.net:8002/
* Login: jdoe@lebobeautyco.com
* Password: sh0ppingC4rt

<!--
## Website Source Code (lebobeautyco.github.io)

The source code for the official lebobeautyco website is available here:

[https://github.com/lebobeautyco/lebobeautyco.github.io](https://github.com/lebobeautyco/lebobeautyco.github.io)
...
lebobeautyco is [MIT licensed](https://github.com/Moe6/lebobeautyco/blob/main/LICENSE).
